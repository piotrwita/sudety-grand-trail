      ...
      <div className="fluid-container relative z-10">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            ...
            {/* Step 2 */}
            <div className="flex items-start space-x-6">
              <div className="flex size-12 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-earth-600 to-earth-700 text-lg font-bold text-cream shadow-vintage">
                2
              </div>
              <div>
                <h4 className="mb-2 text-lg font-bold text-forest-800">
            ...
            {/* Step 3 */}
            <div className="flex items-start space-x-6">
              <div className="flex size-12 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-accent to-yellow-600 text-lg font-bold text-cream shadow-vintage">
                3
              </div>
              <div>
                <h4 className="mb-2 text-lg font-bold text-forest-800">
            ...
            <div className="card-vintage border-forest-300 bg-gradient-to-br from-forest-700/10 to-earth-700/10 p-10">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="flex size-8 flex-shrink-0 items-center justify-center rounded-full bg-forest-600">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-mountain-600">
                      Twoje postępy na żywo na mapie - rodzina i przyjaciele
                      mogą Cię śledzić
                    </p>
                  </div>
                </div>
        ...
        >
          <div className="card-vintage border-yellow-300 bg-gradient-to-r from-yellow-50 to-orange-50 p-8">
            <div className="flex items-start space-x-4">
              <div className="flex size-12 flex-shrink-0 items-center justify-center rounded-full bg-yellow-500">
                <svg
